...
const Shop = ({category}) => {
  ...
  const categories = [
    {
      name: 'Sweaters',
      img: "https://th.bing.com/th/id/OIP.1GHhyxHEzxADKB9-zB3MfQHaHa?rs=1&pid=ImgDetMain",
    },
    {
      name: 'Jackets',
      img: "https://th.bing.com/th/id/OIP.L3is78Ndv2f88F5fEJfmFwHaHa?rs=1&pid=ImgDetMain",
    },
    {
      name: 'Caps', 
      img: "https://th.bing.com/th/id/OIP.sQRxC4CSBd8eyJF6Z41m-wAAAA?rs=1&pid=ImgDetMain",
    },
  ];
  ...
  return (  
    <>
      <Helmet>
        <title>Kids Winter | SaiFashionZone by Raiba</title>
      </Helmet>
      <div className="bg-gradient-to-b from-amber-100 to-amber-200 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold text-red-800 mb-4 tracking-tight"> Winter Wonderland: Keep Your Little Ones Warm and Toasty with Our Winter Wear Collection
            </h2>
            <p className="text-red-700 text-xl max-w-2xl mx-auto leading-relaxed">
            Wrap yourself in warmth and style with our cozy collection of winter wear, featuring the softest fabrics and latest fashion trends to keep you snug and chic
            </p>
          </div>
        </section>
