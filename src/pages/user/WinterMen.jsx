...
const Shop = ({category}) => {
  ...
  const categories = [
    {
      name: 'Sweaters',
      img: "https://th.bing.com/th/id/OIP.1uZf7Ucg7wATKMX9dfg_jQHaHa?rs=1&pid=ImgDetMain",
    },
    {
      name: 'Blazers and Jackets',
      img: "https://images-na.ssl-images-amazon.com/images/I/7155p8b%2BnBL._AC_UL1280_.jpg",
    },
    {
      name: 'Caps and Ear Covers', 
      img: "https://th.bing.com/th/id/OIP.rCcBgWWjoZIAqUX88Eu5dgAAAA?rs=1&pid=ImgDetMain",
    },
  ];
  ...
  return (  
    <>
      <Helmet>
        <title>Men Winter | SaiFashionZone by Raiba</title>
      </Helmet>
      <div className="bg-gradient-to-b from-amber-100 to-amber-200 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold text-red-800 mb-4 tracking-tight"> Brave the Chill: Warm and Stylish Winter Wear for Men
            </h2>
