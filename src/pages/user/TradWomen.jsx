...
const Shop = ({category}) => {
  ...
  const categories = [
    ...
    {
      name: 'Suits and Kurtis',
      img: "https://th.bing.com/th/id/OIP.sxfU7Fp3sr1OvEeproRB_wHaLG?rs=1&pid=ImgDetMain",
    },
    {
      name: 'Lehengas', 
      img: "https://th.bing.com/th/id/OIP.vavDKgJlJ4gYOUNMSw6BSwAAAA?rs=1&pid=ImgDetMain",
    },
  ];
  ...
  return (  
    <>
      <Helmet>
        <title>Women Traditional | SaiFashionZone by Raiba</title>
      </Helmet>
      <div className="bg-gradient-to-b from-amber-100 to-amber-200 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold text-red-800 mb-4 tracking-tight"> Sparkle in Our Curated Collection Of Ethnic Wear
            </h2>
            <p className="text-red-700 text-xl max-w-2xl mx-auto leading-relaxed">
              Discover our exclusive collections tailored just for you, with carefully curated products that speak to your style, personality and festivities.
            </p>
          </div>
        </section>
