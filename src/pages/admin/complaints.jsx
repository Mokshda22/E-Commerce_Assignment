          ...
          <div className="mb-6 flex justify-between items-center">
            <div className="relative w-full max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 border bg-red-500 border-pink-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-white shadow-sm transition-all duration-300"
                value={searchQuery}
          ...
          <div className="bg-red-500 rounded-xl shadow-lg overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-red-700 border-b border-pink-200">
                  <tr>
                    {[
