...
const Shop = ({category}) => {
  ...
  const categories = [
    {
      name: 'Shirts',
      img: "https://th.bing.com/th/id/OIP.2_dc9PrUweJvh7ZV4uRzFgHaJo?rs=1&pid=ImgDetMain",
    },
    {
      name: 'Normal T-Shirts',
      img: "https://i5.walmartimages.com/asr/479dc571-5cd1-4163-9ac1-92649c5a0e34_1.30cb76a4bfce583dbba98fd6026978d7.jpeg",
    },
    {
      name: 'Oversized T-Shirts', 
      img: "https://th.bing.com/th/id/OIP.HQUyps66SoU_YnZS9o-glgHaJQ?rs=1&pid=ImgDetMain",
    },
    {
        name: 'Jeans', 
        img: "https://th.bing.com/th/id/OIP.dxfbceNEgmMOz1nE4BikPQHaLW?rs=1&pid=ImgDetMain",
      },
      {
        name: 'Trousers', 
        img: "https://i5.walmartimages.com/asr/317ba628-4a96-4343-baa9-212ae24cb6da_1.507d685b3608de860f5d85c93210d6e4.jpeg",
      },
      {
        name: 'Tracksuits', 
        img: "https://th.bing.com/th/id/OIP.esfIiQTtW_V7euGi6Vph0QHaJm?rs=1&pid=ImgDetMain",
      },
  ];
  ...
  return (  
    <>
      <Helmet>
        <title>Men Western | SaiFashionZone by Raiba</title>
      </Helmet>
      <div className="bg-gradient-to-b from-amber-100 to-amber-200 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold text-red-800 mb-4 tracking-tight"> Elevate Your Style: Explore Our Collection of Modern Western Wear
            </h2>
            <p className="text-red-700 text-xl max-w-2xl mx-auto leading-relaxed">
            Step into style with our expertly curated collection of western wear, featuring the latest trends and timeless classics to elevate your wardrobe.
            </p>
          </div>
        </section>
