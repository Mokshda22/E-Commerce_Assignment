...
const Shop = ({category}) => {
  ...
  const categories = [
    ...
    },
    {
      ...
      img: "https://th.bing.com/th/id/OIP.CqnmXlI_NNWdsGLDdhHypgAAAA?rs=1&pid=ImgDetMain",
    },
    {
      name: 'Jeans', 
      img: "https://th.bing.com/th/id/OIP.AYtsbxhOTat2cDSikJu0cgHaNI?rs=1&pid=ImgDetMain",
    },
    {
        name: 'T-Shirts', 
        img: "https://i5.walmartimages.com/asr/4ab5ad00-3a7f-46db-9ebe-a6c3fb266482_1.364c215a90023b04f6845c1d688b0419.jpeg",
      }, 
      {
        name: 'Co-Ord Sets', 
        img: "https://th.bing.com/th/id/OIP.g14mtaDtGie2YCODKVldjwHaJ4?rs=1&pid=ImgDetMain",
      }, 
      {
        name: 'Jumpsuits', 
        img: "https://th.bing.com/th/id/OIP.ocSnqqOFj9yqOyITw5w2bAAAAA?rs=1&pid=ImgDetMain",
      },
  ];
  ...
  return (  
    <>
      <Helmet>
        <title>Women Western | SaiFashionZone by Raiba</title>
      </Helmet>
      <div className="bg-gradient-to-b from-amber-100 to-amber-200 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold text-red-800 mb-4 tracking-tight"> Unleash Your Inner Diva: Trendy Western Wear for the Fashionista
            </h2>
