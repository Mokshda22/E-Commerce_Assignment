      ...
      <div className="min-h-screen bg-amber-100 py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            className="bg-red-400 rounded-3xl shadow-2xl overflow-hidden border border-pink-100"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              {/* Product Image Section */}
              <div className="p-8 bg-red-300 flex items-center justify-center">
                <motion.div 
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="border-b border-pink-100 pb-6">
                  <h1 className="text-4xl font-bold text-gray-900 mb-3 bg-white text-transparent bg-clip-text">
                    {product.name}
                  </h1>
                ...
                <div className="flex items-center space-x-4">
                  <div className={`px-4 py-2 rounded-full bg-red-200 flex items-center ${stockStatus?.color}`}>
                  ...
                  <div className="bg-red-200 px-4 py-2 rounded-full flex items-center">
                    <FaTag className="mr-2 text-red-700" />
                    <span className="text-red-700font-medium">
                      {product.category}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center bg-red-300 rounded-lg overflow-hidden">
                      <button 
                        className="px-4 py-2 bg-red-600 hover:bg-red-500 transition"
