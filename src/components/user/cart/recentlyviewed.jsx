...
const RecentlyViewed = () => {
  ...
  if (products.length === 0) {
    return (
      <div className="bg-red-500 shadow-md rounded-lg">
        <div className="p-4 border-b">
          <h2 className="text-xl font-bold text-red-800">Recently Viewed Products</h2>
        </div>
  ...
  return (
    <div className="bg-red-500 shadow-md rounded-lg">
      <div className="p-4 border-b">
        <h2 className="text-xl font-bold text-red-900">Recently Viewed Products</h2>
      </div>
      <div className="p-4">
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-3 text-center">
                ...
                <Link to={`/${product._id}`}>
                  <button 
                    className="mt-2 w-full bg-pink-50 text-red-600 py-2 rounded-md 
