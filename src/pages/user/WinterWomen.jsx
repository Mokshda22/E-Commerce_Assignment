...
const Shop = ({category}) => {
  ...
  const categories = [
    {
      name: 'Sweaters',
      img: "https://content.woolovers.com/img/o/92661-38168_a3l_darkcamel_w_5.jpg",
    },
    {
      name: 'Coats',
      img: "https://th.bing.com/th/id/OIP.cNDfDSuA9KzP5QSVmJep5wAAAA?rs=1&pid=ImgDetMain",
    },
    {
      name: 'Shawls', 
      img: "https://i.etsystatic.com/11144858/r/il/6f649b/3019705296/il_1588xN.3019705296_cn0t.jpg",
    },
  ]; 
  ...
  return (  
    <>
      <Helmet>
        <title>Women Winter | SaiFashionZone by Raiba</title>
      </Helmet>
      <div className="bg-gradient-to-b from-amber-100 to-amber-200 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold text-red-800 mb-4 tracking-tight"> Cozy Up in Style: Our Collection of Warm and Chic Winter Wear
            </h2>
