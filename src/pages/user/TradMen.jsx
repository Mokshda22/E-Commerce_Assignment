...
const Shop = ({category}) => {
  ...
  const categories = [
    {
      name: 'Kurta',
      img: "https://i.etsystatic.com/23727656/r/il/1b7014/2492395980/il_fullxfull.2492395980_tjbx.jpg",
    },
    {
      name: 'Wedding Special',
      img: "https://th.bing.com/th/id/OIP._oXlRMDmevxKXwVvQ2eO6QHaJz?w=696&h=921&rs=1&pid=ImgDetMain",
    },
    {
      name: 'Kurta Pajama Sets', 
      img: "https://i.pinimg.com/originals/41/26/36/412636c5b0111bd45aef33c6985244bf.jpg",
    },
  ];
  ...
  return (  
    <>
      <Helmet>
        <title>Men Traditional | SaiFashionZone by Raiba</title>
      </Helmet>
      <div className="bg-gradient-to-b from-amber-100 to-amber-200 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold text-red-800 mb-4 tracking-tight"> Embrace Your Heritage: Exquisite Traditional Wear for the Modern Man
            </h2>
