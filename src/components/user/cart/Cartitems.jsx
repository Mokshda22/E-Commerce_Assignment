...
const CartItems = () => {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64 bg-amber-100">
  ...
  if (error || cartItems.length === 0) {
    return (
      <div className="bg-red-500 shadow-md rounded-lg p-6 flex flex-col items-center justify-center">
        <img src={emptyCart} alt="Empty Cart" className="w-48 h-48 mb-4" />
        <p className="text-lg text-yellow-400 mb-4">{error || 'Your cart is empty'}</p>
        <Link 
          to="/TradWomen" 
