...
const Dashboard = () => {
    ...
    // Dashboard Render
    return (
        <div className="min-h-screen bg-amber-100 p-6 lg:p-10">
            <div className="container mx-auto">
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-red-800">Dashboard</h1>
                        <p className="text-red-600">Welcome back to SaiFashionZone by Raiba Admin!</p>
                    </div>
                    <button className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition flex items-center" onClick={e=>{setRefresh(!refresh)}}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                    {[
                        ...
                        <div 
                            key={index} 
                            className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border-b-4 border-red-500"
                        >
                            ...
                            <h3 className="text-black text-sm mb-2">{metric.title}</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        >
                            <h2 className="text-lg font-semibold text-red-700 mb-4">{chart.title}</h2>
                            ...
                            <div className="text-center mt-4">
                                <p className="text-3xl font-bold text-red-600">{chart.percentage}%</p>
                                <p className="text-red-500">{chart.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
