...
const Shop = ({category}) => {
  ...
  const categories = [
    {
      name: "Girls' Frock",
      img: "https://i.pinimg.com/originals/73/a9/74/73a974aff0b51f94f0a176a637f4331b.jpg",
    },
    {
      name: "Girls' Jumpsuits",
      img: "https://i.pinimg.com/736x/d6/fb/51/d6fb51b806877315a5b9b88e9a709e22.jpg",
    },
    {
      name: "Girls' Jeans and Tops", 
      img: "https://th.bing.com/th/id/OIP.XiUrZQqrJZuKkL9gEh6aJQHaHa?rs=1&pid=ImgDetMain",
    },
    {
      name: "Boys' T-Shirt Jeans", 
      img: "https://th.bing.com/th/id/OIP.HwKnZx7UDpnbzga3oyYxqwHaHa?rs=1&pid=ImgDetMain",
    },
    {
      name: "Boys' Shirts", 
      img: "https://th.bing.com/th/id/OIP.tRh-9nNmEZ5fWKqv_33lXQHaHa?rs=1&pid=ImgDetMain",
    },
    {
      name: "Pajama Sets", 
      img: "https://images-na.ssl-images-amazon.com/images/I/71KOq45Z4iL._AC_UL1500_.jpg",
    },
  ];
  ...
  return (  
    <>
      <Helmet>
        <title>Kids Western | SaiFashionZone by Raiba</title>
      </Helmet>
      <div className="bg-gradient-to-b from-amber-100 to-amber-200 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold text-red-800 mb-4 tracking-tight">Mini Fashionistas Unite: Cute and Stylish Western Wear for Kids
            </h2>
            <p className="text-red-700 text-xl max-w-2xl mx-auto leading-relaxed">
            Bring out the kid in you with our vibrant collection of kids' wear, designed to spark imagination, comfort, and joy for your little ones
            </p>
          </div>
        </section>
