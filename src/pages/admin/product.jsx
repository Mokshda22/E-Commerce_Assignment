          ...
          <div className="relative">
            <div className={`flex items-center ${isSearchExpanded ? 'w-full md:w-64' : 'w-10 md:w-64'} transition-all duration-300`}>
              ...
              <input
                ...
                className={`pl-10 pr-4 py-2 border bg-red-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-300 ${
          ...
          <table className="min-w-full table-auto">
            <thead className="bg-red-600">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Visibility</th>
              ...
              {filteredProducts.map((product) => (
                <tr key={product.productId}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                    <select
                      className="border rounded px-2 py-1 bg-red-100"
