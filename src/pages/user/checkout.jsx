...
const Checkout = () => {
  ...
  return (      
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        <title>Checkout | SaiFashionZone by Raiba</title>
      </Helmet>
      <Navbar/>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-8">
          {/* Address Section */}
          <div className="md:w-2/3 bg-amber-100rounded-2xl shadow-lg p-8">
            <div className="flex items-center mb-6 space-x-4">
              <MapPin className="text-white w-8 h-8" />
              <h2 className="text-3xl font-bold text-red-800">Shipping Details</h2>
            </div>
            
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-red-700 mb-2">Street Address</label>
                  <input
                    type="text"
                    name="street"
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-red-700 mb-2">Pincode</label>
                  <input
                    type="text"
                    name="pincode"
              ...
              <div className="md:col-span-2 flex items-center space-x-3">
                <input
                  ...
                  className="text-white focus:ring-red-500 rounded"
                />
                <label htmlFor="saveAddress" className="text-sm text-red-700">
