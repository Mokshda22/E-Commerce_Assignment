    ...
    return (
        <>
            ...
            <button 
                ...
                className="fixed top-4 left-4 p-2 rounded-lg hover:bg-red-200 lg:hidden z-50"
            >
                <Menu size={24} />
            </button>
            ...
            {showDialog && (
                <div className="fixed inset-0 bg-white bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-red-500 p-6 rounded-lg w-96">
                        ...
                        <div className="flex mb-3">
                            ...
                            <button
                                ...
                                className="w-1/3 bg-red-700 text-white p-2 rounded-r"
                            >
                                Generate
                            </button>
                        </div>
            ...
            <div className={`fixed left-0 top-0 h-screen bg-red-50 shadow-lg transition-all duration-300 flex flex-col 
                ...
                <div className="mt-auto">
                    <div className={`p-4 ${isOpen ? 'block' : 'hidden'}`}>
                        ...
                        <button 
                            ...
                            className="w-full bg-red-300 text-white py-2 rounded hover:bg-red-400 mb-2"
                        >
                            + Add Product
                        </button>
                        ...
                        <Link 
                            to="/" 
                            className="w-full flex items-center justify-center bg-red-500 text-white py-2 rounded hover:bg-green-600"
                        >
                            Go to Website
                        </Link>
                    </div>
                    ...
                    <footer className={`text-center text-gray-500 text-sm p-4 ${isOpen ? 'block' : 'hidden'}`}>
                        SaiFashionZone by Raiba Admin Dashboard © 2024
                    </footer>
                </div>
            </div>
        </>
